...
def square_color(coord: str) -> str:
    """Zwraca white_squares / black_squares po nazwie pola."""
    ...
    while True:
        ...
        if key == ord("k"):
            ...
            tiles_dict, warped = warp_and_segment_chessboard(
                frame,
                calibration_corners,
                tile_mapping=calibration_mapping,         
            )

            coords = sorted(tiles_dict.keys(),
